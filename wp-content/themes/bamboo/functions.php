...
if ( ! function_exists( 'bamboo_setup' ) ) :
/**
...
function bamboo_setup() {
	 ...
	 * If you're building a theme based on bamboo, use a find and replace
	 * to change 'bamboo' to the name of your theme in all the template files.
	 */
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'bamboo' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'bamboo_custom_background_args', array(
 ...
 */
function bamboo_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'bamboo_content_width', 640 );
}
add_action( 'after_setup_theme', 'bamboo_content_width', 0 );
...
function bamboo_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'bamboo' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'bamboo' ),
